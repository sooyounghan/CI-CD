...
2. Settings - Environments
   - approve process 추가 : Required reviewers 체크 후, reviews에 검토자 추가 - Save Protection Rule 선택
   - staging 추가
<div align="center">
<img src="https://github.com/user-attachments/assets/474409d3-735d-4f74-b476-aa203c5fb77c">
</div>

3. feature-cicd4 Branch 생성 후, App.js 수정 후, PR 생성 
4. 이후, Merge 실행 (dev)
5. 최신 dev Branch Pull 이후, tag v2.0.0으로 Commit 후, test 확인 후(qa), master Bracnh로 Merge(staging)
<div align="center">
<img src="https://github.com/user-attachments/assets/1a02c1bf-6472-4b93-82f4-9ed111cde74c">
</div>


  - Review deployments를 눌러 승인하면, 다음 작업 진행 (staging에서 prod)
<div align="center">
<img src="https://github.com/user-attachments/assets/8514e83e-6e9e-4f63-b5b7-d3c673e17ef7">
</div>
